    ...
    <div class="py-8">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-4">
            <div class="bg-white shadow sm:rounded-lg p-4">
                <form method="GET" action="{{ route('clientes.consulta_parametro') }}" class="space-y-4">
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div>
                            ...
                            <x-text-input id="correo" name="correo" type="text" class="mt-1 block w-full" value="{{ $filters['correo'] ?? '' }}" />
                        </div>
                    </div>
